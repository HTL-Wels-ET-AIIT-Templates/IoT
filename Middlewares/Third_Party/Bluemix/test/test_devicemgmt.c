...
void testInitialize(void **state){
	Config deviceconfig;
	char *devCfgPath;
...
void testInitializeConfigfile(void **state){
...
void testConnectIotf(void **state){
	char *devCfgPath;
...
void testPublishEvent(void **state){
	unsigned char *payload1 = "{ \"d\" : { \"temp\" : 34.0 }}";
	unsigned char *payload2 = "{ \"d\" : { \"temp\" : 14.5 }}";
