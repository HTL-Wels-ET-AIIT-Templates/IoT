...
* Input          : LIS2DH12_ENABLE/LIS2DH12_DISABLE
* Output         : None
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
...
status_t LIS2DH12_SetInt16D4DConfiguration(void *handle, LIS2DH12_INT1_6D_4D_t ic) {
  ...
  if(ic == LIS2DH12_INT1_6D_ENABLE){
    value &= 0xBF;
    value |= (LIS2DH12_ENABLE<<LIS2DH12_INT_6D);
    value2 &= 0xFB;
    value2 |= (LIS2DH12_DISABLE<<LIS2DH12_D4D_INT1);
  }
  ...
  if(ic == LIS2DH12_INT1_4D_ENABLE){
    ...
    value |= (LIS2DH12_ENABLE<<LIS2DH12_INT_6D);
    value2 &= 0xFB;
    value2 |= (LIS2DH12_ENABLE<<LIS2DH12_D4D_INT1);
  }

  if(ic == LIS2DH12_INT1_6D_4D_DISABLE){
    value &= 0xBF;
    value |= (LIS2DH12_DISABLE<<LIS2DH12_INT_6D);
    value2 &= 0xFB;
    value2 |= (LIS2DH12_DISABLE<<LIS2DH12_D4D_INT1);
  }
...
status_t LIS2DH12_SetInt26D4DConfiguration(void *handle, LIS2DH12_INT2_6D_4D_t ic) {
  ...
  if(ic == LIS2DH12_INT2_6D_ENABLE){
    ...
    value |= (LIS2DH12_ENABLE<<LIS2DH12_INT_6D);
    value2 &= 0xFE;
    value2 |= (LIS2DH12_DISABLE<<LIS2DH12_D4D_INT2);
  }
  ...
  if(ic == LIS2DH12_INT2_4D_ENABLE){
    ...
    value |= (LIS2DH12_ENABLE<<LIS2DH12_INT_6D);
    value2 &= 0xFE;
    value2 |= (LIS2DH12_ENABLE<<LIS2DH12_D4D_INT2);
  }
